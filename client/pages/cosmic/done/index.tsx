        ...
        <div className={`${styles.cosmic_body} row align-items-center`}>
          <div className="col-12">
            <p className={`${styles.welcome_text} Aoboshi text-white mb-5`}>
              "ZibZibZabble! You've done an amazing job, space explorer! You've
              successfully completed this level and helped ZabbleZib understand
              human emotions better. Your journey through the galaxy of
              FizzlFizz is making a big difference. Get ready to embark on the
              next exciting level in Cosmic Emotions. Keep up the fantastic
              effort!"
            </p>
          </div>
          <div className="col-3">
