        ...
        <div className={`${styles.cosmic_body} row align-items-center`}>
          <div className="col-9 mx-auto">
            <p className={`${styles.welcome_text} Aoboshi text-white mb-5`}>
              ...
              to comprehend human emotions. Your interstellar journey on Planet
              Emotion is truly making an impact. Prepare to launch into the next
              thrilling level. Keep shining, star explorer!"
            </p>
          </div>
          <div className="col-9 mx-auto">
            <p
