        ...
        >
          <div className="col-11">
            <p className="text-center text-white f22 fw400 Londrina">
              ...
              <br />
              <br />
              ZabbleZib has just landed on Earth and finds human emotions quite
              puzzling. He needs your help to decode these complex feelings so
              he can make friends on Earth.
              <br />
              ...
              express their emotions. As a reward for your help, ZabbleZib will
              share with you some of the most amazing and unique treasures from
              FizzlFizz. These could be glowing space gems, zero-gravity pets,
              or even a piece of a rainbow ring from a FizzlFizz planet!
              <br />
              <br />
              As you journey through the game, you'll help ZabbleZib navigate a
              variety of situations - from simple ones like a child's birthday
              party to more complex ones like a friend moving away.
              <br />
              <br />
