...
// Define an interface for the entire onboarding state, which contains the state of each question, as well as loading and error states
export interface SurveyState {
  questionOne: QuestionOneState | {}; // the state of question one
  questionTwo: QuestionTwoState | {}; // the state of question two
  questionOnePointTwo: QuestionTwoState | {}; // the state of question two
  ...
  error?: string; // a string representing any errors that occur during the onboarding
}

// Define an interface for a onboarding action, which
